...
<form method='POST' action='jsp1.jsp'>
    ¬ª¬Õ¬Ö¬ß¬ä¬Ú¬æ¬Ú¬Ü¬Ñ¬ä¬à¬â: <input readonly name="id" value="<% out.println(aviary.getIdAviary());%>"/>
    ¬¯¬Ñ¬Ù¬Ó¬Ñ¬ß¬Ú¬Ö: <input name="title" value="<% out.println(aviary.getTitle());%>"/>
    <br><br>
    ¬²¬Ñ¬Ù¬Þ¬Ö¬â: <input name="size" value="<% out.println(aviary.getSize());%>"/>
    <br><br>
    <br><br>
